...
public final class ExportConstant {
	...
	public static final String[] EXPORT_BORROW_LIST_HEARDERS = {"真实姓名","手机号","订单号","借款金额(元)","借款期限","订单生成时间","综合费用",
		"实际到账金额","订单状态","放款时间","实际还款时间","实际还款金额(元)","逾期天数","逾期罚金(元)"};
	/** 借款订单导出 属性数组*/
	...
	/** 已还款订单导出 表头*/
	public static final String[] EXPORT_REPAY_LIST_HEARDERS = {"真实姓名","手机号","订单号","借款金额(元)","借款期限(天)","订单生成时间","综合费用","实际到账金额","实际还款金额","订单状态"};
	/** 已还款订单导出 属性数组*/
	public static final String[] EXPORT_REPAY_LIST_FIELDS = {"realName","phone","orderNo","amount","timeLimit","createTime","fee","realAmount","repayAmount","stateStr"};
